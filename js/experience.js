...
$ ( function () {
    ...
    $ ( ".rightBox" ).on ( "click", function () {
        ...
        $ ( ".rightBox" ).stop ( true, false ).animate ( { "width" : "85%" }, 500, function () {
            ...
            $ ( ".schemeBox" ).stop ( true, false ).animate ( { left : 120 }, 500, function () {
                $ ( ".developBox" ).stop ( true, false ).animate ( { left : 350 }, 500, function () {
                    $ ( ".operationBox" ).stop ( true, false ).animate ( { left : 540 }, 500, function () {
                        $ ( ".marketBox" ).stop ( true, false ).animate ( { left : 770 }, 500, function () {
                            $ ( ".consultBox" ).stop ( true, false ).animate ( { left : 1000 }, 500, function () {
                                // 鼠标移入事件
                                var $listBox = $ ( ".listBox" );
